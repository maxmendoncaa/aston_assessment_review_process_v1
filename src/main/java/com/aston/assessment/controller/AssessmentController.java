...
//        assessmentService.addQuestionToInternalModerator(id, question);
//        return ResponseEntity.ok().build();
//    }
//
//    @GetMapping("/{id}/questions")
//    public ResponseEntity<List<Question>> getQuestions(@PathVariable Long id) {
//        List<Question> questions = assessmentService.getQuestionsForInternalModerator(id);
//        return ResponseEntity.ok(questions);
//    }
//
//    @PutMapping("/{id}/external-examiner")
//    public ResponseEntity<Void> updateExternalExaminerResponse(@PathVariable Long id,
//                                                               @RequestParam String comments,
//                                                               @RequestParam boolean reviewAgain,
//                                                               @RequestParam String signature) {
//        assessmentService.updateExternalExaminerResponse(id, comments, reviewAgain, signature);
//        return ResponseEntity.ok().build();
//    }
//
//    @PutMapping("/{id}/programme-director")
//    public ResponseEntity<Void> updateProgrammeDirectorConfirmation(@PathVariable Long id,
//                                                                    @RequestParam boolean appropriatelyResponded,
//                                                                    @RequestParam String signature) {
//        assessmentService.updateProgrammeDirectorConfirmation(id, appropriatelyResponded, signature);
//        return ResponseEntity.ok().build();
//    }
//
